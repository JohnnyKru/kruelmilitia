        ...
        <div class="header"><?php include 'navbar.php';?></div>
			...
			<div class="container-fluid">
			    <div class="row">			
					 ...
					 <div class="kru_bioTxt col-xs-12 col-sm-12 col-md-6 col-lg-8">
					 <h1>Coach Johnny Kru Keokongsy </h1>
						<p>A refugee who escaped the grip of communism. Coach Johnny experienced the hardship of life by moving to a new country, learning a new language, overcame bullying and racism. He noticed that no matter who you are, or what color you are, people want the same thing in life.</p>
						<li>To be part of something. </li>
						<li>To have a purpose in life.</li>
                        <li> To not have fear.</li>
						<li> Inner peace. </li>
                        <br>
						<h1> Benefit of Coach Keokongsy's instructions. </h1>
						<p>"When learning a combative art, most of the fighters I've worked with came from different backgrounds. I do not restrict them from learning other martial arts because, a good coach will always be open to what works for that Individual."</p> 						
						<p> "As a child, Muay Thai was the art I was submersed in. It evolved through the years but there still a mystic about the art and the genius behind the techniques."</p>
                        <br>
						<p>"No matter what background you train in. It can be  Boxing, Kickboxing, Karate, Tea Kon Do or Grappling
						with proper Muay Thai techniques, you will benefit your chances of victories to come. "</p>	
					 </div>	
				</div>		
            </div>		
